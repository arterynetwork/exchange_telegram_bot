...
class BuyHistoryCommand extends Command
{
    /**
     * @var string Command Name
     */
    protected $name = "buy_history";

    /**
     * @var string Command Description
     */
    protected $description = "Активные покупки";
    ...
    public function handle()
    {
        ...
        $this->replyWithMessage(['text' => __('bot.buy_history.list_title', ['count' => $orders->count()])]);
        ...
        foreach ($orders as $order) {
            ...
            if ($order->status == Order::STATUS_BUYER_WAIT) {
                $keyboard[] = [
            ...
            if ($order->status == Order::STATUS_IN_PROCESS) {
                ...
                $keyboard[] = [
                    Keyboard::inlineButton([
                        'text' => 'Реквизиты',
                        'callback_data' => 'buy_attrs_' . $order->id,
                    ]),
                    Keyboard::inlineButton([
                        'text' => __('bot.common.buttons.cancel2'),
                        'callback_data' => 'buy_cnclyn_' . $order->id,
            ...
            $this->replyWithMessage([
                'text' =>
                    ...
                    . "\n<strong>" . __('bot.buy_history.seller') . "</strong>: " . htmlspecialchars($nick) . "\n"
