...
class SellHistoryCommand extends Command
{
    /**
     * @var string Command Name
     */
    protected $name = "sell_history";

    /**
     * @var string Command Description
     */
    protected $description = "Активные продажи";
    ...
    public function handle()
    {
        ...
        $this->replyWithMessage(['text' => __('bot.sell_history.list_title', ['count' => $orders->count()])]);
