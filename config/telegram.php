...
return [
    ...
    */
    'bots' => [
        'artrbot' => [
            'username' => env('TELEGRAM_BOT_USER_NAME', 'YOUR-BOT-USER-NAME'),
            'token' => env('TELEGRAM_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands' => [
                \App\Bot\StartCommand::class,
                \App\Bot\WalletCommand::class,
                \App\Bot\BuyAdsCommand::class,
                \App\Bot\HistoryCommand::class,
                \App\Bot\BuyHistoryCommand::class,
                \App\Bot\SellHistoryCommand::class,
                \App\Bot\FullBuyHistoryCommand::class,
                \App\Bot\FullSellHistoryCommand::class,
                \App\Bot\SellSettingsCommand::class,
                \App\Bot\BuyMenuCommand::class,
                \App\Bot\SellMenuCommand::class,
                \App\Bot\RulesCommand::class,
            ],
        ],
    ],
